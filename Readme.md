This project demonstrates the setup of an AWS VPC and deployment of an Apache web server on an EC2 instance. The steps are documented with commands, configuration files, and screenshots.
